...
#define ZPAD 0x2a // '*'        /* 052 Padding character begins frames */
#define ZDLE 0x18 // 030        /* Ctrl-X Zmodem escape - `ala BISYNC DLE */
#define ZDLEE 0x58 // (ZDLE^0100)       /* Escaped ZDLE as transmitted */
#define ZBIN 0x41 // 'A'        /* Binary frame indicator */
#define ZHEX 0x42 // 'B'        /* HEX frame indicator */
#define ZBIN32 0x43 // 'C'      /* Binary frame with 32 bit FCS */
...
#define TESCCTL 0x40 // 0100	/* Transmitter expects ctl chars to be escaped */
#define TESC8   0x80 // 0200	/* Transmitter expects 8th bit to be escaped */
